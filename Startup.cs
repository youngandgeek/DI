...
namespace DI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Configure DbContext
            services.AddDbContext<DbConnClass>(options =>
            {
                options.UseSqlServer("Data Source=Atty;Initial Catalog=DIDemo;Integrated Security=True");
            });
            // Register custom repositories
            services.AddScoped<IStudent, StudentRepo>();
            services.AddScoped<IDepartmentRepository, DepatmentRepository>();
